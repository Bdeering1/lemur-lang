...
func (ls *LetStatement) String() string {
    ...
    out.WriteString(" = ")
    out.WriteString(ls.Values.String())
    out.WriteString(";")
...
var _ Expression = (*KeyValue)(nil)

func (kv *KeyValue) _exprNode(){}
func (kv *KeyValue) String() string { return fmt.Sprintf("%s: %s", kv.Key, kv.Value) }
